...
const Footer: React.FC = () => {
  return (
    <footer className="bg-zinc-100 text-gray-800 py-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
          <div className="max-w-2xl mb-6 md:mb-0 text-sm text-gray-400">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-sm text-center text-xs text-gray-900">
              &copy; {new Date().getFullYear()} Post Gallery. All rights
              reserved.
            </p>
          </div>
        </div>
